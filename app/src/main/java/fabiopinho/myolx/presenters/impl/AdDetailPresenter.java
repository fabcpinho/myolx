...
import fabiopinho.myolx.view.activity.AdDetailActivity;
 ...
 */
public class AdDetailPresenter implements IAdsPresenter {
    private AdDetailActivity view;
    ...
    public AdDetailPresenter(AdDetailActivity view) {
        this.view = view;
    ...
    public void subscribeCallbacks() {
        ...
        onGetAdByIdCallback = new IAdsRepository.OnGetAdByIdCallback() {
            @Override
            public void onSuccess(Ads ad) {
                view.setCurrentItem(ad);
            }
